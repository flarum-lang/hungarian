...
* Elavult Flarum core fordítások eltávolítva (`2.0` vagy magasabb verzió támogatott).
* Elavult ellenőrzési fordítások eltávolítva (`2.0` vagy magasabb verzió támogatott).
...
**Elavult bővítmények támogatása megszüntetve**:
...
* [`datitisev/flarum-ext-dashboard`](https://github.com/dsevillamartin/flarum-ext-dashboard)
...
Összes változás: [v2.10.1...v3.0.0](https://github.com/flarum-lang/hungarian/compare/v2.10.1...v3.0.0).
...
Összes változás: [v2.5.0...v2.5.1](https://github.com/flarum-lang/hungarian/compare/v2.5.0...v2.5.1).
